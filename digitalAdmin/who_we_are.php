  ...
  <!--breadcrumbs-->
    <div id="content-header">
      <div id="breadcrumb">
        ...
        <a  class="current" data-original-title="Go to Home">Who We Are</a>
      </div>
      ...
      <div class="row-fluid">
        ...
        <div class="widget-box" id="addContainer" style="display: none;">
          <div class="widget-title bg_lg">
            ...
            <h5>Create Who We Are Details</h5> 
          </div>
          <div></div> 
        ...
        <div class="widget-box">
          ...
          <div class="widget-title bg_lg"><span class="icon"><i class="icon-signal"></i></span>
            <h5>Who We Are Details</h5>
           <div class="btn btn-primary btn-lg pull-right" style="margin-top: 3px; margin-right: 3px;" id="btnCreate">Create Who We Are Details</div>
           <div class="btn btn-danger btn-lg pull-right" style="margin-top: 3px; margin-right: 3px; display: none;" id="btnCancel">Cancel</div>
          </div>
          <div></div>  
          <div class="widget-content ">
            <h4><center>View Who We Are Details </center></h4>
            <table class="table table-bordered data-table">
              ...
              <tbody id="tableContainer">
                <?php
                  $record = $obj->select("*","who_we_are","1");
...
<script src="../assets/admin/js/custom/who_we_are.js"></script>
<!--end-js-part-->
